...
},{}],"loginAndOut.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            (0, _alerts.showAlert)('success', 'Processing...');
            _context.next = 4;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            (0, _alerts.showAlert)('error', 'Processing...');
            _context2.next = 4;
            return (0, _axios.default)({
              method: 'GET',
...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGVyZW11YmFzaGlyIiwiYSI6ImNrN2hsbzU3bDA5MG8za2xwM3EyYXBqaTAifQ.wpZKS4Bvk90pmz5K3AhRnA';
...
var stripe = Stripe('pk_test_z3xKGxk5E3dWm5AuWwDV9Zbr001j4jXnJr');

function getCheckoutSession(_x) {
  return _getCheckoutSession.apply(this, arguments);
}

function _getCheckoutSession() {
  _getCheckoutSession = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("".concat(document.location.origin, "/api/v1/bookings/checkout-session/").concat(tourId));
...
var _loginAndOut = require("./loginAndOut");
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    (0, _loginAndOut.login)(email, password);
  });
}
...
if (logoutBtn) {
  logoutBtn.addEventListener('click', _loginAndOut.logout);
}
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _booking.getCheckoutSession)(tourId);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "13008" + '/');
